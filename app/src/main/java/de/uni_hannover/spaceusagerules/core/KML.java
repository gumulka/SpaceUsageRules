...
public class KML {
 ...
 /*   public static List<LatLng> loadKML(InputStream is) {
    ...
    public static List<LatLng> loadKML(String kml) {
        Document doc = null;
        List<LatLng> coordinates = new LinkedList<LatLng>();
    ...
    public static String writeKML(List<LatLng> coordinates, String name) {
        String coords = "";
